...
CustomKeywords.'hcc2_b2b.ForgotPassword.ValidateForgotPassword'()

TestLinkAPIClient api=new TestLinkAPIClient(GlobalVariable.ApiInterfaceGui, GlobalVariable.xmlUrl);

api.reportTestCaseResult(GlobalVariable.ProjectName, GlobalVariable.TestPlan_Sprint1, "TC-B2B-11", GlobalVariable.BuildName_Sprint1, GlobalVariable.Comment, GlobalVariable.Status)
