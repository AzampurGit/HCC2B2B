...
CustomKeywords.'hcc2_b2b.RecommendedProducts.AddProductInTrolleyFromRecommendedPage'()

TestLinkAPIClient api=new   TestLinkAPIClient(GlobalVariable.ApiInterfaceGui,GlobalVariable.xmlUrl);

api.reportTestCaseResult(GlobalVariable.ProjectName,  GlobalVariable.TestPlan_Sprint5, "TC-B2B-281",  GlobalVariable.BuildName_Sprint5, GlobalVariable.Comment,GlobalVariable.Status)
